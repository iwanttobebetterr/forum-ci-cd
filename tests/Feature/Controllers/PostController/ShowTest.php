...
it('passes the post to the view', function () {
    ...
    get($post->showRoute())->assertHasResource('post', new PostResource($post));
});
...
it('passes comments of post to the view', function () {
    ...
    get($post->showRoute())->assertHasPaginatedResource('comments', CommentResource::collection($comments->reverse()));
});
